...
$description = '株式会社あさまかい グループホームサンタクロースの応募前見学ページです。';//メタディスクリプションをここに挿入
...
<section id="visit1" class="content">
	...
	<p class="cont">
		...
		そして実際に、スタッフが働く様子を間近で見られます。入居者さんとのやりとりやスタッフ同士の雰囲気を見てみると、“イメージがガラッと変わる”発見があるかもしれません。
	</p>
	<div class="opendate">
		<p>開催日時</p>
		<ul>
