		...
		<li class="thumbnails">
			<div class="thumbnail">
				...
				<hgroup>
					<h3>竹内駿さん</h3>
					<p>
						私は、制御設計の仕事を担当しています。<br><br>
						これは、機械がちゃんと動くようにプログラムをつくったり、調整したりする仕事です。お客様の工場に行って、実際の機械に制御プログラムを入れたり、オプション品を取り付けたりして、全体の動きを調整しています。<br><br>
						毎回、機械を作る人の希望や機械の種類がちがうので、いろいろなことにチャレンジできるのが楽しいし、やりがいを感じます！<br><br>
						会社のまわりは自然がたくさんあって、休憩中にのんびり散歩することが多いです。ひとりの時間を大切にしたい人にもぴったりな環境だと思います。<br><br>
