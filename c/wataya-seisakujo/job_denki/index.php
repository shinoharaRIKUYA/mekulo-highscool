...
<section class="g" id="job_detail">
	...
	<p>
		どれだけ完璧な構造でも、機械は形ができただけでは動きません。<br>
	...
	<p>
        ...
        図面を見ると、「この線はここ」「この端子にはこれ」とすべて決まっていて、やるべきことは明確。ですが、たった一つのミスで機械は動かなくなってしまいます。<br>
        だからこそ、正確さと集中力が求められます。
	</p>
	<div class="images">
		<img src="contents01.jpg" alt="" class="scene">
	</div>
	<p>
		使う工具は、ドライバー・ニッパー・圧着機など。<br>
        最初は難しく見えても、やるべき手順を一つひとつ積み重ねていけば、必ずできるようになります。
	</p>
	<div class="images">
	...
	<p>
		入社後は、社内勉強会からスタート。図面の読み方や工具の使い方など、基礎から丁寧に学びます。<br>
		メーカーによって、電線の種類もさまざま。最初は覚えることが多いですが、手を動かしていれば自然と技術が身についていきます。経験を積んでいくと、１台の機械の配線を、最初から最後まで自分１人で仕上げられるようになるでしょう。<br>
		電気科出身じゃなくても大丈夫！未経験から始めた先輩たちも、活躍しています。
	</p>
</section>
<section class="g">
	<h2>写真で雰囲気を知る</h2>
